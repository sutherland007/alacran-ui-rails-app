Rails.application.routes.draw do
  ...
  root 'home#index', :locale => /es|en/, as: :redirected_root, via: [:get]
  match '/home', to: 'home#index', :locale => /es|en/, via: [:get]
  match ':locale/home', to: 'home#index', :locale => /es|en/, via: [:get]

  match '/alr_admin', to: 'alr_admin/alr_admin#index', :locale => /es|en/, via: [:get]
  match '/(:locale)/alr_admin', to: 'alr_admin/alr_admin#index', :locale => /es|en/, via: [:get]
